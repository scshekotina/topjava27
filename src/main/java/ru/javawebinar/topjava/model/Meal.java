...
@NamedQueries({
        ...
        @NamedQuery(name = Meal.BETWEEN_HALF_OPEN, query = "SELECT m FROM Meal m WHERE m.user.id=:userId AND m.dateTime>=:from AND m.dateTime<:to ORDER BY m.dateTime DESC"),
