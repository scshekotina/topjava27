    ...
    <table border="1" cellpadding="8" cellspacing="0">
        ...
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href=<spring:url value="/meals/update?id=${meal.id}"/>><spring:message code="meal.update"/></a>
                </td>
                <td><a href=<spring:url value="/meals/delete?id=${meal.id}"/>><spring:message code="meal.delete"/></a>
                </td>
            </tr>
        </c:forEach>
    </table>
